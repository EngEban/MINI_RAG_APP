        ...
        async with self.db_client() as session:
            async with session.begin():
                ...
                for record in records:
                    # JSONB should already deserialize cleanly, but keep a defensive parse for driver/environment differences.
                    # This keeps retrieval responses stable for downstream consumers.
